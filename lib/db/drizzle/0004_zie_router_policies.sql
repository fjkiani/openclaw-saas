...
VALUES
  ('manuscript_slop_check',  'liquid/lfm-2.5-1.2b:free', 'openrouter', 'OPENROUTER_API_KEY', 512,  8000),
  ('legal_clause_analysis',  'liquid/lfm-2.5-1.2b:free', 'openrouter', 'OPENROUTER_API_KEY', 768,  10000),
  ('seo_content_audit',      'liquid/lfm-2.5-1.2b:free', 'openrouter', 'OPENROUTER_API_KEY', 512,  8000)
